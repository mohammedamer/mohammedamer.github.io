...
# ╔═╡ e3a82b8e-b99f-11f0-ba5e-e92653e603c7
md"For simulation:

$\dot{\omega}_1 = \frac{g \sin(\theta_1)}{L_1}$
"

# ╔═╡ fd5037d4-0405-4d38-bba6-d2cf10257a9c
md"$\dot{\omega}_2 = -\frac{\csc(\theta_2)\left(-g m_2+ L_1 \omega_1^2(m_1 \cos(\theta_2)+m_2 \cos(\theta_1)- L_1 m_1 \dot{\omega}_1 \cot(\theta_1)\cos(\theta_2)+L_1 m_2\dot{\omega}_1 \sin(\theta_1)+L_2 m_2 \omega_2^2 \cos(\theta_2)\right)}{L_2 m_2}$"

# ╔═╡ ab05d088-7493-4720-992a-97c9a572bdfa
md"
$\omega_1 = \dot{\theta}_1$
"

# ╔═╡ bc2f7dc0-6b47-419c-8b9c-905370b42b2c
md"
$\omega_2 = \dot{\theta}_2$
"

# ╔═╡ 7563cfc8-f6d2-4758-aac9-c99f468d19b7
import DifferentialEquations as DE

# ╔═╡ 65a64f99-9948-4156-90b3-d3af80f6acd1
begin
	L1 = 1.
	L2 = 1.
	m1 = 1.
...
# ╔═╡ f7da10bd-573c-43b4-90e2-ca14a11d8f70
function f(u, p, t)
	θ1, θ2, ω1, ω2 = u
	...
	dω1 = g *sin(θ1)/L1
	dω2 = (csc(θ2) * (-g* m2 + L1* ω1^2* (m1* cos(θ2) + m2* cos(θ1) - L1* m1* cot(θ1)* cos(θ2) + L1* m2* dω1* sin(θ1) + L2* m2* ω2^2* cos(θ2))))/(L2* m2)

	[dθ1, dθ2, dω1, dω2]
end

# ╔═╡ 1dd74139-c9da-4080-96c1-6dc9ff83a08f
begin
	u0 = [1., 2., 0, 0.]
	tspan = (0.0, 5.0)
...
# ╔═╡ f2367ac0-7d0f-4880-ba61-c6c9df514020
sol = DE.solve(prob)

# ╔═╡ cee7c991-f239-4983-a8dc-517181cc75e7
for (θ1, θ2, _, _) in sol.u
	print(θ1, θ2)
end
